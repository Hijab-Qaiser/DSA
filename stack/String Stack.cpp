...
void Push(string value)
{
    ...
    Names[stackpointer] = value;     // add value
...
void Pop()
{
    ...
    stackpointer = stackpointer - 1; // return pointer to taken slo
    cout << Names[stackpointer] << " was popped from stack" << "\n";
    cout << "New values of stack are: " << "\n";
    for (int i = 0; i < stackpointer; i++)
    {
        cout << Names[i] << " ";
